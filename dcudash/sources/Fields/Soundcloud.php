 ...
 */
class _Soundcloud extends \IPS\Helpers\Form\Text
{
	/**
	...
	{
		$this->childDefaultOptions['placeholder'] = \IPS\Member::loggedIn()->language()->addToStack('field_placeholder_soundcloud');
	...
	public static function displayValue( $value, $customField )
	{
		...
		return \IPS\Theme::i()->getTemplate( 'records', 'dcudash', 'global' )->soundcloud( urlencode( $value ), $params );
	}
	...
	public function validate()
	{
		...
		if ( $this->value )
		{
			...
			/* Check its a valid Soundcloud URL */
